...
PROJECT_GIT=DonJanosch/flask-qrgenerator # Specify the github-path to the project e.g. user/project will lead to https://github.com/user/project.git
PROJECT_PORT=8080 # Speficy which port of the project shal be exposed to port 80
